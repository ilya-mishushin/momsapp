...
const PhotoView: React.FC = () => {
    ...
    useEffect(() => {
        const fetchPhoto = async () => {
            try {
                const response = await axios.get(`${process.env.REACT_APP_API_URL}/photo/${id}`, {
                    responseType: 'blob'
                });
    ...
    const handleSaveToAlbum = async (albumId: number) => {
        try {
            await axios.post(`${process.env.REACT_APP_API_URL}/albums/${albumId}/photos`, {
                photoId: id
            });
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_API_URL}/photo/${id}`);
            navigate('/');
        } catch (err) {
